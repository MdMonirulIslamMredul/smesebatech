                    ...
                    <form action="{{ route('update.testimonial') }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" rows="5" name="name"
                                value="{{ $testimonial->name }}" id="name" placeholder="Name">
                        </div>
                        <div class="form-group">
                            <label>Designation</label>
                            <input type="text" class="form-control" rows="5" name="designation"
                                value="{{ $testimonial->designation }}" id="designation" placeholder="Designation">
                        </div>
                        <div class="form-group">
                            <label>Star</label>
                        ...
                        <img src="{{ asset($testimonial->image) }}" class="mb-2" height="100" width="100"
                            alt="">
