    ...
    <div class="row mt-2">
        <div class="col-lg-12">
            <div class="card">
                ...
                @endif
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('store.testimonial') }}" enctype="multipart/form-data"
                        method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" rows="5" name="designation" id="designation"
                    ...
                    <tbody>
                        @foreach ($testimonials as $testimonial)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('edit.testimonial', ['id' => $testimonial->id]) }}"
