                ...
                <div class="card-body">
                    <form action="{{ route('update.blogs') }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" rows="5" name="title" id="service_title"
                                value="{{ $blog->title }}" placeholder="Blogs Title">
                        </div>
                        <div class="form-group">
                            <label>Blogs Image</label>
                            <input type="file" name="main_image" class="form-control">
                        </div>
                        <img src="{{ asset($blog->main_image) }}" class="mb-2" height="100" width="100"
                            alt="">
                        ...
                        <img src="{{ asset($blog->banner_image) }}" class="mb-2" height="100" width="100"
                            alt="">

                        <h3>Details BLog information</h3>

                        <div class="form-group">
                            <label>Blog Small Details</label>
                        ...
                        <img src="{{ asset($blog->details_image1) }}" class="mb-2" height="100" width="100"
                            alt="">
                        ...
                        <img src="{{ asset($blog->details_image2) }}" class="mb-2" height="100" width="100"
                            alt="">
                        ...
                        <img src="{{ asset($blog->details_image3) }}" class="mb-2" height="100" width="100"
                            alt=""> --}}
