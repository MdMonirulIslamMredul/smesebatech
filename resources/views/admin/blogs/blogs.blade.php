    ...
    <div class="row mt-2">
        <div class="col-lg-12">
            <div class="card">
                ...
                @endif
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('store.blogs') }}" enctype="multipart/form-data"
                        method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" rows="5" name="title" id="title"
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="editor form-control" col="10" row="3" name="short_details"></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="editor form-control" row="3" name="details1"></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="editor form-control" row="3" name="details2"></textarea>
                        </div>
