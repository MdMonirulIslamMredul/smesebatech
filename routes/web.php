...
Route::get('/team-detail/{id}', [WebsiteController::class, 'team_detail'])->name('team.detail');
...
Route::get('/products', [WebsiteController::class, 'package_page'])->name('package.page');
...
Route::get('/video-gallery/{id}', [WebsiteController::class, 'video_details'])->name('video.details');
...
//contact message admin start
Route::get('/admin/contact-messages', [ContactMessageController::class, 'index'])->name('admin.contact.messages')->middleware('is_admin');
Route::post('/admin/contact-messages/{id}/status', [ContactMessageController::class, 'updateStatus'])->name('admin.contact.messages.status')->middleware('is_admin');
//contact message admin end
