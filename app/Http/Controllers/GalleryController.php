...
class GalleryController extends Controller
{
    ...
    public function tech_web_update_gallery(Request $request)
    {
        ...
        return redirect()->route('add.gallery')->with('message', 'gallery update successfully');
    }
    ...
    public function tech_web_update_video_gallery(Request $request)
    {
        ...
        return redirect()->route('add.video.gallery')->with('message', 'gallery update successfully');
    }
}
